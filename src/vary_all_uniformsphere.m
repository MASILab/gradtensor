    ...
    for p = 1:n
        for o = 1:n 
	     ...
	     if mod(idx,13881200)==0
                save("/nfs/masi/kanakap/projects/LR/ten_sim/CorrectionLReffectsresults61d_"+ int2str(idx) +".mat",'-v7.3');
             end
        end
    end
end
save('/nfs/masi/kanakap/projects/LR/ten_sim/CorrectionLReffectsresults61d.mat','-v7.3');
