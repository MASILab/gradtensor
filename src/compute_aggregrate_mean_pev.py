...
true_fa = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_future_fieldmap/p_3tb_posA_mask_primary_eigvec.nii').get_fdata()

corpt_fa_dict = {}
cpre = '/nfs/masi/kanakap/projects/LR/aggregate_study/'
cpost = '/uncorrected_primary_eigvec.nii'
for i in range(1,20):
    outdir = cpre + 'OUTPUT_' +str(i) + cpost
...
post = '/approx_corrected_primary_eigvec.nii'
for i in range(1,20):
    outdir = pre + 'OUTPUT_' +str(i) + post
...
epost = '/emp_corrected_primary_eigvec.nii'
corr_bx_fa_dict = {}
for i in range(1,20):
    outdir = epre + 'OUTPUT_' +str(i) + epost
    corr_fa = nib.load(outdir).get_fdata()
