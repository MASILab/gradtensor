...
# Inputs
dwi_path=/nfs/masi/kanakap/projects/LR/masivar_input/$1
org_bvec_path=/nfs/masi/kanakap/projects/LR/masivar_input/$2
org_bval_path=/nfs/masi/kanakap/projects/LR/masivar_input/$3
mask_path=/nfs/masi/kanakap/projects/LR/masivar_input/$4
initial_SNR=$5
out_dir=/nfs/masi/kanakap/projects/LR/masivar_output/SNR$5_d$6_$7
...
~/MATLAB_2017a_install/bin/matlab -nodisplay -nosplash -nodesktop -r "disp('adding packages');addpath(genpath('/home/local/VANDERBILT/kanakap/gradtensor/external/spm_read_nii'));addpath(genpath('/home/local/VANDERBILT/kanakap/gradtensor/external/spm_reslice'));addpath('/home/local/VANDERBILT/kanakap/gradtensor/src/sh_basis');addpath('/nfs/masi/kanakap/xnat_apps/masimatab/trunk/xnatspiders/matlab/justinlib_v1_7_0/niftilib/');addpath('/home/local/VANDERBILT/kanakap/XNAT/TemporalLobe/revised_matlab_functions/');disp('Reconstruct corrput signal');compute_noise_corrput_signal_v1('$dwi_path','$mask_path','$out_dir','$uncorr_out_name','$Limg_file','$org_bvec_path','$org_bval_path',$initial_SNR);disp('Compute FA/MD/PEV of LR+noise signal');dti_voxel_fit_sig('$uncorrected_sig','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$uncorr_out_name');disp('Compute FA/MD/PEV of noise signal');dti_voxel_fit_sig('$Nuncorrected_sig','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$Nest_uncorr_out_name');disp('Compute FA/MD/PEV of LR signal');dti_voxel_fit_sig('$Luncorrected_sig','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$Lest_uncorr_out_name');disp('Approximate correction LR+noise');compute_approx_corr_dwi('$Limg_file','$uncorrected_sig','$org_bval_path','$org_bvec_path','$mask_path','$approx_out_name','$out_dir');disp('Approximate correction noise');compute_noise_approx_corr_dwi('$Nuncorrected_sig','$org_bval_path','$org_bvec_path','$mask_path','$Napprox_out_name','$out_dir'); disp('Approximate correction LR');compute_approx_corr_dwi('$Limg_file','$Luncorrected_sig','$org_bval_path','$org_bvec_path','$mask_path','$Lapprox_out_name','$out_dir'); disp('Compute FA/MD/PEV of LR+noise approximate correction');dti_voxel_fit_sig('$approx_corrected','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$approx_out_name');disp('Compute FA/MD/PEV of noise approximate correction');dti_voxel_fit_sig('$Napprox_corrected','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$Napprox_out_name');disp('Compute FA/MD/PEV of LR approximate correction');dti_voxel_fit_sig('$Lapprox_corrected','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$Lapprox_out_name');disp('Empirical correction LR+noise');apply_gradtensor_to_b('Limg_file','$Limg_file','refimg_file','$uncorrected_sig','bval_file','$org_bval_path','bvec_file','$org_bvec_path','out_dir','$emp_out_dir');disp('Empirical correction noise');apply_noise_gradtensor_to_b('Limg_file','$Limg_file','refimg_file','$Nuncorrected_sig','bval_file','$org_bval_path','bvec_file','$org_bvec_path','out_dir','$Nemp_out_dir');disp('Empirical correction LR');apply_gradtensor_to_b('Limg_file','$Limg_file','refimg_file','$Luncorrected_sig','bval_file','$org_bval_path','bvec_file','$org_bvec_path','out_dir','$Lemp_out_dir'); exit"
