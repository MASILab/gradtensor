...
~/MATLAB_2017a_install/bin/matlab -nodisplay -nosplash -nodesktop -r "disp('adding packages');addpath(genpath('../external/spm_read_nii'));addpath(genpath('../external/spm_reslice'));addpath('sh_basis');addpath('/nfs/masi/kanakap/xnat_apps/masimatab/trunk/xnatspiders/matlab/justinlib_v1_7_0/niftilib/');addpath('/home/local/VANDERBILT/kanakap/XNAT/TemporalLobe/revised_matlab_functions/');disp('Reconstruct corrput signal');compute_corrput_signal('$dwi_path','$bvec_folder','$bval_folder','$mask_path','$out_dir','$out_name_uncorr','$rL_path','$org_bvec_path','$org_bval_path'); disp(' Compute FA/MD/PEV of corrput signal');dti_voxel_fit_sig('$uncorrected_sig','$bvec_path','$bval_path','$mask_path','$out_dir','$uncorr_out_name');disp('Approximate correction');apply_approx_correction('$Limg_file','$refimg_file','$org_bval_path','$org_bvec_path','$mask_path','$approx_out_name','$out_dir'); disp('Compute FA/MD/PEV of approximate correction');dti_voxel_fit_sig('$approx_corrected','$org_bvec_path','$org_bval_path','$mask_path','$out_dir','$approx_out_name'); disp('Empirical correction'');apply_gradtensor_to_b('$Limg_file','$refimg_file','$org_bval_path','$org_bvec_path','$out_dir');exit"
...
~/MATLAB_2017a_install/bin/matlab -nodisplay -nosplash -nodesktop -r "disp('Compute FA/MD/PEV of empirical correction');dti_voxel_fit('$uncorrected_sig','$bvec_folder','$bval_folder','$mask_path','$out_dir','$emp_out_name')"
