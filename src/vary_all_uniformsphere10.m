...
for i = 1:nv
    ...
    for p = 1:n
        for o = 1:n
            ...
            [S_corpt, S, abvec, abval] = ten_compute_corrput_signal10(DT_true, L_mat, g, b);
	     ...
	     if mod(idx,13881200)==0
                save("/nfs/masi/kanakap/CorrectionLReffectsresults30d_SNR10_"+ int2str(idx) +".mat",'-v7.3');
             end
        end
    end
end
save('/nfs/masi/kanakap/CorrectionLReffectsresults30d_SNR10.mat','-v7.3');
