...
# Empircal correction
echo "RUNNING LR EMP CORRECTION";
...
python lr_sh_to_sig.py $dwi_path $org_bvec_path $org_bval_path $Lemp_bvec_folder $Lemp_bval_folder $out_dir $Lemp_out_name
...
cp $anat_dir/* $out_dir;
cp $seg_dir/* $out_dir;
francois_out=/nobackup/p_masi_brain_map/kanakap/LR/MASiVar_kids/$1/tracto_op_lr_emp_corr_$5;
mkdir $francois_out;
