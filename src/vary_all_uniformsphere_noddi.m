...
% bval and bvec
g = importdata('noddi.bvec');
b = importdata('noddi.bval');
...
for i = 1:nv
    ...
    for p = 1:n
        for o = 1:n
            ...
            [S_corpt, S, abvec, abval] = ten_compute_corrput_signal(DT_true, L_mat, g, b);
	     ...
	     if mod(idx,1)==0%3881200)==0
	     	save("/nfs/masi/kanakap/CorrectionLReffectsresultsNoddi_"+ int2str(idx) +".mat",'-v7.3');
	     end
        end
    end
end
save('/nfs/masi/kanakap/CorrectionLReffectsresultsNoddi_all.mat','-v7.3');
