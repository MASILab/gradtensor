...
% bval and bvec
g = importdata('30direction1shell.bvec');
b = importdata('30direction1shell.bval');
...
for i = 1:nv
    ...
    for p = 1:n
        for o = 1:n
            ...
            [S_corpt, S, abvec, abval] = ten_compute_corrput_signal100(DT_true, L_mat, g, b);
	    ...
	    RD_sim_noise = compute_RD(D_sim_noise);
	     ...
	     if mod(idx,13881200)==0
                save("/nfs/masi/kanakap/projects/LR/ten_sim/CorrectionLReffectsresults31d_noise_SNR100_"+ int2str(idx) +".mat",'-v7.3');
             end
        end
    end
end
toc
save('/nfs/masi/kanakap/projects/LR/ten_sim/CorrectionLReffectsresults31d_noise_SNR100.mat','-v7.3');
