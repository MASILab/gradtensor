...
dwi_path_gz=/nfs/masi/kanakap/projects/LR_tract/MASiVar_kids/$1/prequal_dwi_cat/$2.gz;
gzip -dc $dwi_path_gz > /tmp/decompress/$2;
dwi_path=/tmp/decompress/$2;
org_bvec_path=/nfs/masi/kanakap/projects/LR_tract/MASiVar_kids/$1/prequal_dwi_cat/$4;
org_bval_path=/nfs/masi/kanakap/projects/LR_tract/MASiVar_kids/$1/prequal_dwi_cat/$3;
#mask_path=/nfs/masi/kanakap/projects/LR/masivar_input/$4
initial_SNR=inf;
out_dir=/nfs/masi/kanakap/projects/LR_tract/MASiVar_kids/$1/tracto_ip_$5;
mkdir $out_dir;
