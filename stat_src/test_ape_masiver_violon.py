...
corpt_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/uncorrected_fa.nii').get_fdata()
noise_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/uncorrected_Nest_fa.nii').get_fdata()
lcorpt_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/uncorrected_Lest_fa.nii').get_fdata()
...
inf_corpt_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNRinf_d32_1/uncorrected_fa.nii').get_fdata()
inf_noise_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNRinf_d32_1/uncorrected_Nest_fa.nii').get_fdata()

sm_corr_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/approx_corrected_fa.nii').get_fdata()
Nsm_corr_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/approx_Ncorrected_fa.nii').get_fdata()
bx_corr_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/emp/emp_corrected_fa.nii').get_fdata()
Nbx_corr_fa = nib.load('/nfs/masi/kanakap/projects/LR/masivar_output/SNR30_d32_1/Nemp/Nemp_corrected_fa.nii').get_fdata()
...
plt.subplot(3,1,1)
ax = sns.violinplot(data=pd_data, hue = 'label', x = 'x',y='Abs percent error (%)',dodge=False,width=.5,gridsize=1500,palette=palette)
