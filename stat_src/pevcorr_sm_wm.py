...
nib.save(nib.Nifti1Image(MD_diff_atlas,atlas_img.affine),'/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/ISMRM_sm/pevdiff_avg_wmlabels.nii.gz')
...
plt.title('Simple Correction of WM regions of MR scan at isocenter')
#plt.xlim([-0.00025, 0.00010])
...
#plt.xlim([-0.00025,0.00010])
plt.title('Simple Correction of WM regions of MR scan at isocenter - sorted by LRfield')
plt.subplots_adjust(left=0.445, bottom=0.065, right=0.985, top=0.950, wspace=0, hspace=0)
