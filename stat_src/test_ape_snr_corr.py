...
noise_fainf = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNRinf_d32_1/uncorrected_Nest_fa.nii').get_fdata()
bx_corr_fainf = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNRinf_d32_1/emp/emp_corrected_fa.nii').get_fdata()
sm_corr_fainf = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNRinf_d32_1/approx_corrected_fa.nii').get_fdata()
