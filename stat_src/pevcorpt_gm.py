...
MD_Lest = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_estimates/Lest_primary_eigvec.nii').get_fdata()
...
for i in range(1,208):
    for x in range(96):
        for y in range(96):
            for z in range(68):
                 if atlas[x,y,z] == i:
                     diff = angular_error(MD_Lest,MD_true,halfPi=True)
                     alldiff.append(diff)
