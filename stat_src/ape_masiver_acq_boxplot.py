...
true_fa_32 =  nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_d32_/true__fa.nii').get_fdata()
corpt_fa100_32 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_d32_1/uncorrected_fa.nii').get_fdata()
sm_corr_fa100_32 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_d32_1/approx_corrected_fa.nii').get_fdata()
bx_corr_fa100_32 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_d32_1/emp_corrected_fa.nii').get_fdata()
...
true_fa_40 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_/true__fa.nii').get_fdata() 
corpt_fa100_40 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_1/uncorrected_fa.nii').get_fdata()
sm_corr_fa100_40 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_1/approx_corrected_fa.nii').get_fdata()
bx_corr_fa100_40 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_1/emp_corrected_fa.nii').get_fdata()
...
true_fa_91 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_d94_/true__fa.nii').get_fdata()
corpt_fa100_91 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_d94_1/uncorrected_fa.nii').get_fdata()
sm_corr_fa100_91 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_d94_1/approx_corrected_fa.nii').get_fdata()
bx_corr_fa100_91 = nib.load('/nfs/masi/kanakap/projects/LR/aggregate_study/OUTPUT_masivar_SNR100_d94_1/emp_corrected_fa.nii').get_fdata()
