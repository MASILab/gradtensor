...
MD_Lest = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/ISMRM_sm_noflip/Lest_corr_sm_primary_eigvec.nii').get_fdata()
...
nib.save(nib.Nifti1Image(MD_diff_atlas,atlas_img.affine),'/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/ISMRM_sm/pevdiff_avg_gmlabels.nii.gz')
...
plt.ylabel('∆ PEV degree')
#plt.ylim([-0.00025,0.00010])
plt.subplots_adjust(left=0.045, bottom=0.385, right=0.995, top=0.955, wspace=0, hspace=0)
#plt.xticks(range(1, len(labels) + 1), labels, rotation=90)
plt.title('Simple Correction of GM regions of MR scan at isocenter')
...
plt.title('Simple Correction of GM regions of MR scan at isocenter - sorted by LRfield')
plt.show()
