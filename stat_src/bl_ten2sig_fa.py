...
ten_raw = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/INPUTS/3_dwmri_fa.nii').get_fdata()
...
ten_est = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_signal_estimate/3_est_fa.nii').get_fdata()
...
ten_Lest = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_signal_estimate/3_Lest_fa.nii').get_fdata()
MD_est_d_uncorr = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_signal_estimate/3_Lest_og_ob_fa.nii').get_fdata()
MD_sm_d_corr = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_simple_method_est/2_sm_fa.nii').get_fdata()
...
cmap = plt.get_cmap('viridis')
im = plt.imshow(np.abs(slice), vmin=m, vmax=M, cmap=cmap)
plt.title('FA (Est D^ uncorr) - FA (D)')
divider = make_axes_locatable(plt.gca())
ax = divider.append_axes("right", size="5%", pad=0.05)
plt.colorbar(im, cax=ax)
...
diff_corr = ten_Lest - MD_est_d_uncorr
...
cmap = plt.get_cmap('viridis')
im = plt.imshow(np.abs(slice), vmin=m, vmax=M, cmap=cmap)
plt.title('FA (Est D^corr bx) - FA (Est D^uncorr)')
divider = make_axes_locatable(plt.gca())
ax = divider.append_axes("right", size="5%", pad=0.05)
plt.colorbar(im, cax=ax)
...
diff_sm_corr = MD_sm_d_corr - MD_est_d_uncorr
...
cmap = plt.get_cmap('viridis')
im = plt.imshow(np.abs(slice), vmin=m, vmax=M, cmap=cmap)
plt.title('FA (Est D^sm_corr) - FA (Est D^uncorr')
divider = make_axes_locatable(plt.gca())
ax = divider.append_axes("right", size="5%", pad=0.05)
plt.colorbar(im, cax=ax)
...
#cmap = plt.get_cmap('viridis')
#im = plt.imshow(np.abs(slice), vmin=m, vmax=M, cmap=cmap)
#plt.title('FA (Est D^sm_corr) - FA (D)')
#divider = make_axes_locatable(plt.gca())
#ax = divider.append_axes("right", size="5%", pad=0.05)
#plt.colorbar(im, cax=ax)
