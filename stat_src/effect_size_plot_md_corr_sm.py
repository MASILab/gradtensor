...
true_fa = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_masiver/true__md.nii').get_fdata()
true_fa_dict = {}
for i in range(1,10):
...
img = nib.load('/home/local/VANDERBILT/kanakap/gradtensor_data/10_29_2019_human_repositioned/3tb/posA/OUTPUTS_masiver/true__md.nii')
coh = nib.Nifti1Image(aa, img.affine, img.header)
nib.save(coh, 'cohend_image_snr30_appr_md.nii')
